...
% ============================================================
% SLIDE 13: APPLICATION TO MPSIF (the headline use case)
% ============================================================
\begin{frame}{Applied to the live MPSIF Sub-Fund}
  \vspace{2pt}
  \begin{itemize}
    \item Apply Inertia v2 as an overlay on the May 2026 portfolio.
    \item Synthetic backtest: assume the portfolio's static FF5 exposures
          ($\beta_{\text{MKT}} = 0.88$, $\beta_{\text{HML}} = -0.10$, $\beta_{\text{RMW}} = +0.40$, $\beta_{\text{CMA}} = -0.40$, $\beta_{\text{SMB}} = -0.20$).
    \item Add a long-short FF5 sleeve sized at 50 percent of NAV, driven by Method C's filtered probabilities.
  \end{itemize}
  \vspace{14pt}
  \begin{center}
  \footnotesize
  \begin{tabular}{l r r r r}
    ...
    \midrule
    Static MPSIF (synthetic)        & 11.2\% & 14.0\% & 0.80 & $-44.8\%$ \\
    \rowcolor{lightpurple}
    \emphp{MPSIF + Inertia overlay} & \textbf{12.7\%} & 14.4\% & \textbf{0.88} & \textbf{$-38.3\%$} \\
    \bottomrule
  \end{tabular}
  \end{center}
  \vspace{12pt}
  \footnotesize Sharpe lift \textbf{+0.08}, max drawdown reduced by \textbf{6.5 percentage points}. Paired bootstrap CI $[-0.06, +0.22]$, $p = 0.24$.
\end{frame}

% ============================================================
% SLIDE 14: MPSIF FACTOR EXPOSURES
% ============================================================
\begin{frame}{How the overlay reshapes MPSIF's factor profile}
  \vspace{-4pt}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{figures/22_mpsif_factor_exposure_bars.png}
  \end{center}
  \vspace{-4pt}
  \footnotesize Today's portfolio (blue) versus its overlaid version (purple). Each factor's effective exposure shifts based on its current regime probability. SMB exposure tightens because Method C reads small-caps as currently stressed.
\end{frame}

% ============================================================
% SLIDE 15: CUMRET COMPARISON
% ============================================================
\begin{frame}{Synthetic MPSIF: with vs without overlay}
  \vspace{-4pt}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{figures/21_mpsif_overlay_cumret.png}
  \end{center}
  \vspace{-4pt}
  \footnotesize Backtest 1990 to 2026 of the synthetic MPSIF with fixed FF5 exposures, with and without the Inertia overlay.
\end{frame}

% ============================================================
% SLIDE 16: DRAWDOWN COMPARISON (extra evidence of risk reduction)
% ============================================================
\begin{frame}{Drawdown comparison}
  \vspace{-4pt}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{figures/24_mpsif_overlay_drawdown.png}
  \end{center}
  \vspace{-4pt}
  \footnotesize The overlaid portfolio's troughs are systematically less deep, especially through the 2008 GFC and the 2020 COVID shock.
\end{frame}
...
\begin{frame}{Honest risks}
  ...
  \begin{tabular}{p{0.27\textwidth} p{0.42\textwidth} p{0.21\textwidth}}
    ...
    Synthetic MPSIF betas, not realized & 50 stocks change every rebalance; betas are estimates from rebalance code design & Numbers are illustrative \\[4pt]
    Limited live OOS evidence & Backtest covers 33 years and multiple regimes & Future regime breaks possible \\
    \bottomrule
  \end{tabular}
  \end{center}
\end{frame}
